...
#     # Adding some of your friend's keywords
...
#     job_embeddings = model.encode(df['text_for_embedding'].tolist(), convert_to_tensor=True, show_progress_bar=True)
...
def generate_and_save_data():
    ...
    # --- Data Cleaning ---
    df.dropna(subset=['job_title', 'job_description'], inplace=True)
    df.drop_duplicates(subset=['job_description'], inplace=True) # Keep this to remove identical resumes
